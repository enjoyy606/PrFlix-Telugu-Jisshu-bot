...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href="https://t.me/PRFlixMoviesUpdate">PR Flix Telugu Movies &lt;/&gt;</a></blockquote>"""
...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/PRFlixMoviesUpdate'>PR Flix Telugu Movies &lt;/&gt;</a></b></blockquote>"""

    ABOUT_TEXT = """<blockquote><b>‣ ᴍʏ ɴᴀᴍᴇ : PR Flix Movies bot
‣ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/PRFlixMoviesUpdate'>PR Flix Telugu Bots &lt;/&gt;</a>
‣ ʟɪʙʀᴀʀʏ : ᴘʏʀᴏɢʀᴀᴍ
‣ ʟᴀɴɢᴜᴀɢᴇ : ᴘʏᴛʜᴏɴ
‣ ᴅᴀᴛᴀ ʙᴀsᴇ : ᴍᴏɴɢᴏ ᴅʙ
‣ ʜᴏsᴛᴇᴅ ᴏɴ  :  ᴡᴇʙ
...
If there is an error, ask in the support group @PRFlixMoviesUpdate</b>"""
...
🆔 ᴜᴘɪ ɪᴅ ➩ <code>@PRFlixMoviesUpdate</code> [ᴛᴀᴘ ᴛᴏ ᴄᴏᴘʏ]
 
⛽️ ᴄʜᴇᴄᴋ ʏᴏᴜʀ ᴀᴄᴛɪᴠᴇ ᴘʟᴀɴ: /myplan

🏷️ <a href='https://t.me/PRFlixMoviesUpdate'>ᴘʀᴇᴍɪᴜᴍ ᴘʀᴏᴏꜰ</a>
